...
function build() {
  ...
  for (const city of cities) {
    ...
    fs.writeFileSync(path.join(cityDir, 'index.html'), renderCityPage(city, site, cities, services));
    builtCities++;
  ...
  console.log(`Built ${builtCities} live city page(s), ${builtServices} service page(s), + homepage into dist/`);
  for (const city of cities) {
